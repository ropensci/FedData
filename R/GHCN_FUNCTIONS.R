...
#' }
get_ghcn_daily <- function(template = NULL, label = NULL, elements = NULL, years = NULL, raw.dir = "./RAW/GHCN/", extraction.dir = paste0("./EXTRACTIONS/", 
    label, "/GHCN/"), standardize = F, force.redo = F) {
